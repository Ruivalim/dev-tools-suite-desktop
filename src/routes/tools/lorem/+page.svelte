...
<div class="h-full flex flex-col">
  ...
  <div class="mb-4 flex items-center justify-between">
    <div class="flex items-center gap-3">
      <div class="p-2 rounded-lg bg-accent-500/10">
        <FileText class="w-6 h-6 text-accent-500" />
      </div>
      <div>
    ...
    <div class="flex flex-wrap items-center gap-4">
      ...
      <div class="flex items-center gap-2">
        ...
        <input
          ...
          min="1"
          max="100"
          class="w-20 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 text-sm focus:ring-2 focus:ring-accent-500 focus:border-transparent"
        />
      </div>
  ...
  <!-- Output -->
  <div class="flex-1 flex flex-col bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
    <div class="flex items-center justify-between p-3 border-b border-slate-200 dark:border-slate-800">
      ...
      <button
        onclick={copyOutput}
        disabled={!output}
        class="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-50 transition-colors"
      >
        {#if copied}
